...
public void displayUserDetails() 
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(191, 89, -1, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel2.setText("Name");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(191, 139, 70, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel3.setText("Role");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(191, 186, 70, -1));

        userIDLabel.setText("jLabel4");
        add(userIDLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(315, 89, 180, -1));

        nameLabel.setText("jLabel5");
        add(nameLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(315, 139, 180, -1));

        roleLabel.setText("jLabel6");
        add(roleLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(315, 186, 180, -1));
        ...
        add(managePersonButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 320, -1, -1));
